//take the courseId from the url and token, user from redux store.
//use the courseId and token to get the course details from the backend.
//use the dispatch to store the course data , completed lectures and total lectures in the redux store, whenever the page loads.

//inside the return statement
//check if the user is a student or not, if not then redirect to the home page.
//if the user is a student then show the video details sidebar and the outlet(child routes)
